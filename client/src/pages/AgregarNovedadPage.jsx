...
import NovedadValidation from '../func/NovedadValidation.js'
import axiosInstance from '../func/axiosInstance.js'
import { toast, Toaster } from 'sonner'
import Navbar from '../components/navbar/Navbar.jsx'

const AgregarNovedadPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const validationError = NovedadValidation(values)
  ...
  return (
    <>
      ...
      <header className="flex items-center justify-between border-b p-2 bg-primary">
        ...
        <h1 className="text-3xl font-bold">Agregar Novedad</h1>
      </header>
      <div
...
export default AgregarNovedadPage
